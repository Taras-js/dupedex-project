...
const Image = require("../../file-mongo-express-react-node/models/Image");
const upload = require("../../file-mongo-express-react-node/middleware/upload");
const auth = require("../../file-mongo-express-react-node/middleware/auth.middleware");
const router = Router();
const { limits } = upload;
